...
import { tasks } from '../test-data/TasksTableData';
...
const Tasks = () => {
  ...
  return (
    <>
    <Box sx={{ margin: '30px', className: 'table-container' }}>
      <MaterialReactTable
  ...
  return (
    <Dialog open={open}>
      ...
      <DialogActions sx={{ p: '1.25rem' }}>
        ...
        <Button className='create-button'  onClick={handleSubmit} variant="contained">
          Create
        </Button>
      </DialogActions>
    </Dialog>
